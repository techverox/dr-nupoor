...
const solution = SOLUTIONS_DATA["local-seo-agencies"];
...
export default function LocalSeoAgenciesPage() {
  return (
    <main className="relative min-h-screen bg-[#FCFDFD] text-slate-900 selection:bg-amber-500/20 selection:text-amber-900 font-sans">
      <GlobalSpotlightGrid />
      <Navbar />
