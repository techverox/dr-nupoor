...
const solution = SOLUTIONS_DATA["performance-agencies"];
...
export default function PerformanceAgenciesPage() {
  return (
    <main className="relative min-h-screen bg-[#FCFDFD] text-slate-900 selection:bg-emerald-500/20 selection:text-emerald-900 font-sans">
      <GlobalSpotlightGrid />
      <Navbar />
