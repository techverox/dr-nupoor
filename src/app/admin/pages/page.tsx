...
export default function AdminPagesContentPage() {
  ...
  return (
    <div className="flex flex-col gap-6 max-w-[1600px] mx-auto font-sans pb-16">
      {/* Top Header Bar */}
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pb-4 border-b border-slate-200/90">
        <div>
          ...
          <p className="text-xs sm:text-sm text-slate-500 mt-1">
            Edit headlines, clinical narratives, stats, and CTAs across core website pages. Changes reflect live on the patient portal upon saving.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2.5 flex-wrap">
          <Link
            ...
            className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl border border-slate-200 bg-white text-xs font-bold text-slate-700 hover:bg-slate-50 transition-colors shadow-2xs"
          >
          ...
          >
            {showPreview ? <Eye className="w-3.5 h-3.5 text-emerald-600" /> : <EyeOff className="w-3.5 h-3.5" />}
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl border border-slate-200 bg-white text-xs font-bold text-slate-600 hover:text-amber-600 hover:bg-amber-50/50 transition-colors cursor-pointer"
          >
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl border border-slate-200 bg-white text-xs font-bold text-slate-700 hover:bg-slate-50 transition-colors shadow-2xs cursor-pointer"
          >
          ...
          <button
            ...
            disabled={isSaving}
            className="inline-flex items-center gap-2 px-5 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold shadow-sm transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-60 cursor-pointer"
          >
          ...
          <div className={`${showPreview ? "lg:col-span-7" : "w-full"} flex flex-col gap-6`}>
              ...
              <>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setHomeData((prev) => ({ ...prev, heroBadge: e.target.value }))}
                        placeholder="SPECIALISED BREAST CARE IN AHMEDABAD"
                        className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 bg-slate-50/50 text-sm font-semibold text-slate-900 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 focus:bg-white"
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      <div className="sm:col-span-2">
                        ...
                        <input
                          ...
                          placeholder="Expert Care for"
                          className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 bg-slate-50/50 text-sm font-semibold text-slate-900 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 focus:bg-white"
                        />
                      </div>
                      <div>
                        <label className="block text-xs font-bold text-slate-700 mb-1.5">
                          Highlight Word (Rose Tint)
                        </label>
                        <input
                          type="text"
                          value={homeData.heroHeadlineHighlight || ""}
                          onChange={(e) => setHomeData((prev) => ({ ...prev, heroHeadlineHighlight: e.target.value }))}
                          placeholder="Every Woman"
                          className="w-full px-3.5 py-2.5 rounded-xl border border-rose-300 bg-rose-50/40 text-sm font-bold text-[#D84C70] focus:outline-none focus:ring-2 focus:ring-[#D84C70]/20 focus:border-[#D84C70] focus:bg-white"
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        placeholder="Compassionate, evidence-based and personalised breast care..."
                        className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 bg-slate-50/50 text-xs sm:text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 focus:bg-white leading-relaxed"
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3.5 py-2 rounded-xl border border-slate-200 text-xs font-bold text-slate-900"
                        />
                      </div>
                      <div>
                        <label className="block text-xs font-bold text-slate-700 mb-1.5">
                        ...
                        <input
                          ...
                          className="w-full px-3.5 py-2 rounded-xl border border-slate-200 text-xs font-mono text-slate-600"
                        />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          placeholder="Consult on WhatsApp"
                          className="w-full px-3.5 py-2 rounded-xl border border-slate-200 text-xs font-bold text-slate-900"
                        />
                      </div>
                      <div>
                ...
                <div className="bg-white border border-slate-200/90 rounded-2xl p-6 shadow-xs">
                  <div className="flex items-center gap-2.5 pb-4 mb-5 border-b border-slate-100">
                    ...
                    <h2 className="text-sm font-bold text-slate-900 uppercase tracking-wider">
                      Clinical Awareness &amp; Health Statistics
                    </h2>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="p-3.5 rounded-xl border border-slate-100 bg-slate-50/50 space-y-2">
                      ...
                      <input
                        ...
                        placeholder="1 in 8"
                        className="w-full px-3 py-1.5 rounded-lg border border-slate-200 text-sm font-bold text-slate-900 bg-white"
                      />
                      <input
                        type="text"
                        value={homeData.stat1Label || ""}
                        onChange={(e) => setHomeData((prev) => ({ ...prev, stat1Label: e.target.value }))}
                        placeholder="Women may develop breast cancer"
                    ...
                    <div className="p-3.5 rounded-xl border border-slate-100 bg-slate-50/50 space-y-2">
                      ...
                      <input
                        ...
                        placeholder="Survival rate with early detection"
                        className="w-full px-3 py-1.5 rounded-lg border border-slate-200 text-xs text-slate-600 bg-white"
                      />
                    </div>
                    ...
                    <div className="p-3.5 rounded-xl border border-slate-100 bg-slate-50/50 space-y-2">
                      ...
                      <input
                        ...
                        placeholder="Screening saves lives"
                        className="w-full px-3 py-1.5 rounded-lg border border-slate-200 text-xs text-slate-600 bg-white"
                      />
                    </div>
                    ...
                    <div className="p-3.5 rounded-xl border border-slate-100 bg-slate-50/50 space-y-2">
                      ...
                      <input
                        ...
                        placeholder="We are here to support"
                        className="w-full px-3 py-1.5 rounded-lg border border-slate-200 text-xs text-slate-600 bg-white"
                      />
                    </div>
                  </div>
                ...
                <div className="bg-white border border-slate-200/90 rounded-2xl p-6 shadow-xs">
                  <div className="flex items-center gap-2.5 pb-4 mb-5 border-b border-slate-100">
                    ...
                    <h2 className="text-sm font-bold text-slate-900 uppercase tracking-wider">
                      Supporting Narratives &amp; Bottom Consultation CTA
                    </h2>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <label className="block text-xs font-bold text-slate-700 mb-1.5">
                        Bottom Consultation Subtitle
                      </label>
                      <textarea
                        rows={2}
                        value={homeData.ctaSectionSubtitle || ""}
                        onChange={(e) => setHomeData((prev) => ({ ...prev, ctaSectionSubtitle: e.target.value }))}
                        className="w-full px-3.5 py-2 rounded-xl border border-slate-200 text-xs text-slate-600"
                      />
                    </div>
                  </div>
                </div>
              ...
              <>
                <div className="bg-white border border-slate-200/90 rounded-2xl p-6 shadow-xs">
                  <div className="flex items-center gap-2.5 pb-4 mb-5 border-b border-slate-100">
                    ...
                    <h2 className="text-sm font-bold text-slate-900 uppercase tracking-wider">
                      About Us Hero &amp; Clinical Positioning
                    </h2>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      <div className="sm:col-span-2">
                        ...
                        <input
                          ...
                          placeholder="Dedicated to Women's Health."
                          className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 text-sm font-semibold text-slate-900"
                        />
                      </div>
                      <div>
                        <label className="block text-xs font-bold text-slate-700 mb-1.5">
                          Highlight Phrase (Rose Tint)
                        </label>
                        <input
                          type="text"
                          value={aboutData.heroHeadlineHighlight || ""}
                          onChange={(e) => setAboutData((prev) => ({ ...prev, heroHeadlineHighlight: e.target.value }))}
                          placeholder="Today and Always."
                          className="w-full px-3.5 py-2.5 rounded-xl border border-rose-300 text-sm font-bold text-[#D84C70] bg-rose-50/30"
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 text-xs sm:text-sm text-slate-700 leading-relaxed"
                      />
                    </div>
                  </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <textarea
                          ...
                          className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 text-xs text-slate-700 leading-relaxed"
                        />
                      </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      <div className="sm:col-span-2">
                        ...
                        <input
                          ...
                          placeholder="Get in Touch with Dr. Noopur Patel"
                          className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 text-sm font-semibold text-slate-900"
                        />
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          placeholder="For Dedicated Care"
                          className="w-full px-3.5 py-2.5 rounded-xl border border-emerald-300 text-sm font-bold text-emerald-700 bg-emerald-50/30"
                        />
                      </div>
                    </div>
            ...
            <div className="flex items-center justify-between pt-2">
              <span className="text-xs text-slate-400">
                Tip: Press <kbd className="px-1.5 py-0.5 rounded bg-slate-100 text-slate-700 border text-[10px] font-mono">Cmd+S</kbd> to save immediately.
              </span>
              <button
                type="button"
                onClick={saveCurrentTab}
                disabled={isSaving}
                className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold shadow-sm transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-60 cursor-pointer"
              >
            ...
            <div className="lg:col-span-5">
              <div className="sticky top-20 flex flex-col gap-3">
                <div className="flex items-center justify-between px-1">
                  ...
                  <span className="text-[11px] text-slate-400 font-mono">Interactive Stage</span>
                </div>
                ...
                <div className="rounded-2xl border border-slate-200/90 bg-white shadow-md overflow-hidden">
                  ...
                  <div className="px-4 py-2.5 bg-slate-50 border-b border-slate-200/80 flex items-center justify-between">
                    ...
                    <div className="px-3 py-0.5 rounded-md bg-white border border-slate-200 text-[11px] font-mono text-slate-500">
                      drnoopurpatel.com{getLivePageUrl()}
                    </div>
                  ...
                  {/* Preview Body */}
                  <div className="p-6 sm:p-7 bg-[#FCFDFD]">
                    {/* HOMEPAGE PREVIEW */}
                    {activeTab === "home" && (
                      <div className="space-y-5 text-left">
                        <div>
                          <div className="inline-block text-[10px] font-bold text-[#D84C70] tracking-wider uppercase bg-pink-50 px-2 py-0.5 rounded-full mb-2">
                            {homeData.heroBadge || "SPECIALISED BREAST CARE"}
                          </div>
                          <h3 className="text-2xl sm:text-3xl font-serif font-bold tracking-tight text-slate-900 leading-[1.15]">
                            {homeData.heroHeadline || "Expert Care for"}{" "}
                            <span className="text-[#D84C70]">
                              {homeData.heroHeadlineHighlight || "Every Woman"}
                            </span>
                          </h3>
                          <p className="text-xs text-slate-600 mt-3 leading-relaxed font-normal">
                            {homeData.heroSubheadline || "Compassionate, evidence-based and personalised breast care..."}
                          </p>
                        </div>

                        {/* CTA Buttons preview */}
                        <div className="flex flex-wrap items-center gap-2.5 pt-1">
                          <span className="px-4 py-2 rounded-full text-xs font-bold text-white bg-[#D84C70] shadow-xs inline-flex items-center gap-1.5">
                            <span>{homeData.primaryCtaText || "Book an Appointment"}</span>
                            <ArrowRight className="w-3.5 h-3.5" />
                          </span>
                          <span className="text-xs font-semibold text-slate-700 px-3 py-2">
                            {homeData.secondaryCtaText || "Consult on WhatsApp"}
                          </span>
                        </div>
                    ...
                    {activeTab === "about" && (
                      <div className="space-y-5 text-center">
                        <div className="max-w-md mx-auto">
                          <h3 className="text-2xl font-serif font-bold text-slate-900 tracking-tight leading-[1.15]">
                            {aboutData.heroHeadline || "Dedicated to Women's Health."}{" "}
                            <span className="text-[#D84C70]">
                              {aboutData.heroHeadlineHighlight || "Today and Always."}
                            </span>
                          </h3>
                      ...
                      <div className="space-y-4 text-center">
                        <div>
                          <h3 className="text-xl font-serif font-bold text-slate-900 tracking-tight">
                            {contactData.heroHeadline || "Get in Touch with Dr. Noopur Patel"}{" "}
                            <span className="text-[#D84C70]">
                              {contactData.heroHeadlineHighlight || "For Dedicated Care"}
                            </span>
                          </h3>
