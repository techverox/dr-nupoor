...
export default function AdminSubscribersPage() {
  ...
  const handleResetToDefaults = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        showToast("✅ Audience Contacts Restored to 10 Canonical DigiVigee Defaults!");
      } else {
  ...
  const handleAddSubscriber = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setNewEmail("");
        fetchSubscribers();
        showToast(`🎉 ${newEmail} enrolled into Weekly Growth Insights!`);
      } else {
  ...
  return (
    <div className="space-y-6 pb-16">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          <div className="space-y-2">
            <div className="flex flex-wrap items-center gap-2.5">
              ...
              <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-200 dark:border-emerald-900/60 text-emerald-700 dark:text-emerald-400 text-xs font-bold">
                ...
                <span>Live Audience Synced (100% Real Website Data)</span>
              </div>
            </div>
            ...
            <p className="text-sm text-zinc-500 dark:text-zinc-400 max-w-2xl">
              Manage verified audience contacts, subscription statuses, campaign attribution, and broadcast mailing lists.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            ...
            <a
              ...
              download
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 text-zinc-800 dark:text-zinc-200 font-bold text-xs transition-colors cursor-pointer"
            >
      ...
      {/* 4 Bento Metric Cards (Child-Friendly & High Contrast) */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-3xl border border-zinc-200 dark:border-zinc-800 p-5 shadow-sm flex flex-col justify-between gap-3 hover:border-zinc-300 dark:hover:border-zinc-700 transition-all">
          <div className="flex items-start justify-between">
            ...
            <div className="p-2 rounded-2xl bg-blue-50 dark:bg-blue-950/60 text-blue-600 dark:text-blue-400 border border-blue-100 dark:border-blue-900/60">
              <Users className="w-5 h-5" />
            </div>
          </div>
          <div>
            <div className="text-3xl font-black text-zinc-900 dark:text-zinc-100 tracking-tight">
              {totalCount}
            </div>
            <p className="text-[11px] text-zinc-400 dark:text-zinc-500 mt-2 line-clamp-1">
              Registered subscribers across all DigiVigee funnels
            </p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-3xl border border-zinc-200 dark:border-zinc-800 p-5 shadow-sm flex flex-col justify-between gap-3 hover:border-zinc-300 dark:hover:border-zinc-700 transition-all">
          <div className="flex items-start justify-between">
            ...
            <div className="p-2 rounded-2xl bg-emerald-50 dark:bg-emerald-950/60 text-emerald-600 dark:text-emerald-400 border border-emerald-100 dark:border-emerald-900/60">
          ...
          <div>
            ...
            <p className="text-[11px] text-zinc-400 dark:text-zinc-500 mt-2 line-clamp-1">
              Receiving Weekly Growth Insights newsletter
            </p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-3xl border border-zinc-200 dark:border-zinc-800 p-5 shadow-sm flex flex-col justify-between gap-3 hover:border-zinc-300 dark:hover:border-zinc-700 transition-all">
          <div className="flex items-start justify-between">
            ...
            <div className="p-2 rounded-2xl bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400 border border-zinc-200 dark:border-zinc-700">
              <UserMinus className="w-5 h-5" />
            </div>
          </div>
          <div>
            <div className="text-3xl font-black text-zinc-600 dark:text-zinc-400 tracking-tight">
              {totalUnsub}
            </div>
            <p className="text-[11px] text-zinc-400 dark:text-zinc-500 mt-2 line-clamp-1">
              Contacts who opted out of broadcast deliveries
            </p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-3xl border border-zinc-200 dark:border-zinc-800 p-5 shadow-sm flex flex-col justify-between gap-3 hover:border-zinc-300 dark:hover:border-zinc-700 transition-all">
          <div className="flex items-start justify-between">
            ...
            <div className="p-2 rounded-2xl bg-amber-50 dark:bg-amber-950/60 text-amber-600 dark:text-amber-400 border border-amber-100 dark:border-amber-900/60">
          ...
          <div>
            ...
            <p className="text-[11px] text-zinc-400 dark:text-zinc-500 mt-2 line-clamp-1">
              Active retention rate across marketing lifecycle
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-3xl border border-zinc-200 dark:border-zinc-800 p-4 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-4">
        {/* Search Input */}
        <div className="relative w-full sm:max-w-md">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2.5 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 text-xs font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 dark:text-zinc-200"
          />
        </div>
        ...
        {loading ? (
          ...
          <div className="p-16 text-center text-zinc-400 space-y-3">
            ...
            <p className="text-xs max-w-sm mx-auto text-zinc-500">
              Try changing your search keywords or click &quot;Reset to Defaults&quot; to restore canonical audience data.
            </p>
          </div>
        ) : (
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs">
              <thead>
                <tr className="border-b border-zinc-200 dark:border-zinc-800 text-zinc-400 font-bold uppercase tracking-wider bg-zinc-50/50 dark:bg-zinc-800/40">
                    ...
                    >
                      ...
                      <td className="py-4 pl-6 pr-4">
                        <div className="flex items-center gap-3">
                          <div className="w-9 h-9 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 text-white flex items-center justify-center font-black text-xs shrink-0 shadow-sm">
                      ...
                      <td className="py-4 px-4">
                        <span
                          className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-black tracking-wide uppercase ${
                            isActive
                              ? "bg-emerald-50 text-emerald-700 dark:bg-emerald-950/60 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-900/60"
                      ...
                      <td className="py-4 px-4">
                        {sub.utmCampaign ? (
                          <div>
                            <span className="inline-flex items-center px-2.5 py-0.5 rounded-md font-bold text-[10px] bg-zinc-100 text-zinc-700 dark:bg-zinc-800 dark:text-zinc-300">
                              {sub.utmCampaign}
                            </span>
                            {sub.utmSource && (
                          ...
                          <span className="text-[11px] text-zinc-400 font-medium">Direct / Organic</span>
                        )}
                      </td>

                      {/* Date */}
                      <td className="py-4 px-4 text-zinc-500 dark:text-zinc-400 font-medium">
                        {dateFormatted}
                      </td>
                          ...
                          <button
                            ...
                            className={`px-3 py-1.5 rounded-xl text-xs font-bold transition-all shadow-sm cursor-pointer disabled:opacity-50 ${
                              isActive
                                ...
                                : "bg-emerald-50 hover:bg-emerald-100 dark:bg-emerald-950/60 dark:hover:bg-emerald-900/60 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800"
                            }`}
                          >
                          ...
                          {deleteConfirmId === sub.id ? (
                            <div className="inline-flex items-center gap-1.5 animate-in fade-in zoom-in-95 duration-150">
                              ...
                              <button
                                ...
                                className="px-2.5 py-1.5 bg-zinc-100 hover:bg-zinc-200 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-300 rounded-xl text-xs font-bold cursor-pointer"
                              >
                                Cancel
                              </button>
                            </div>
                            ...
                            <button
                              ...
                              className="p-2 text-zinc-400 hover:text-rose-600 hover:bg-rose-50 dark:hover:text-rose-400 dark:hover:bg-rose-950/40 rounded-xl transition-colors cursor-pointer"
      ...
      <ConfirmDialog
        ...
        title="Restore Canonical Audience Baseline?"
        message={`This will reset newsletter subscribers to DigiVigee's verified canonical 10-subscriber audience across all marketing funnels, blogs, and landing pages.\n\nAll email records, attribution sources, and statuses will be immediately synchronized.`}
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-3xl border border-zinc-200 dark:border-zinc-800 p-6 max-w-md w-full shadow-2xl space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                <div className="p-2 rounded-xl bg-blue-50 dark:bg-blue-950/60 text-blue-600 dark:text-blue-400 border border-blue-100 dark:border-blue-900/60">
            ...
            <form onSubmit={handleAddSubscriber} className="space-y-4 pt-2">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 text-xs font-medium focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              ...
              <div>
                ...
                <input
                  type="email"
                  required
                  placeholder="e.g. rahul@enterprisebrand.com"
                  value={newEmail}
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 text-xs font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer"
                >
                  ...
                  <option value="Blog Insights: Weekly Growth">Blog Insights: Weekly Growth</option>
                  <option value="Homepage OS Hero Newsletter">Homepage OS Hero Newsletter</option>
                  <option value="Audit Funnel Lead Magnet">Audit Funnel Lead Magnet</option>
                </select>
              </div>
              ...
              <div className="flex items-center justify-end gap-2.5 pt-3">
                <button
                  type="button"
                  onClick={() => setShowAddModal(false)}
                  className="px-4 py-2.5 rounded-xl text-xs font-bold text-zinc-600 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-800 cursor-pointer"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  disabled={isAdding}
                  className="px-5 py-2.5 rounded-xl text-xs font-bold text-white bg-blue-600 hover:bg-blue-700 shadow-md shadow-blue-600/20 cursor-pointer flex items-center gap-2"
                >
