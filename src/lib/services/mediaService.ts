...
export const SEED_MEDIA_ITEMS: MediaItem[] = [
  ...
  {
    id: "media-logo",
    name: "DigiVigee Primary Brand Logo",
    fileName: "digivigee_logo.png",
    url: "/images/digivigee_logo.png",
    storagePath: "images/digivigee_logo.png",
    mimeType: "image/png",
    fileSize: 17796,
    width: 512,
    height: 128,
    altText: "DigiVigee Digital Marketing Agency Logo",
    title: "DigiVigee Brand Logo",
    caption: "Primary brand identity logo for light and dark navigation headers",
