...
export const CANONICAL_REDIRECTS: RedirectItem[] = [
  {
    id: "red-1",
    sourcePath: "/treatments",
    destinationPath: "/services",
    statusCode: 301,
    isActive: true,
    note: "Legacy treatments URL routed to clinical services directory",
    hitCount: 214,
  ...
  {
    id: "red-2",
    sourcePath: "/patient-reviews",
    destinationPath: "/testimonials",
    statusCode: 301,
    isActive: true,
    note: "Patient reviews and verified survivor testimonials directory",
    hitCount: 382,
  ...
  },
  {
    ...
    statusCode: 301,
    isActive: true,
    note: "Annual mammogram and breast screening appointment shortcut",
    hitCount: 429,
  ...
  },
  {
    ...
    statusCode: 302,
    isActive: true,
    note: "Direct Marengo CIMS Hospital Clinical WhatsApp Desk",
    hitCount: 681,
  ...
  },
  {
    ...
    statusCode: 301,
    isActive: true,
    note: "Urgent biopsy review & surgical second opinion desk",
    hitCount: 195,
  ...
  {
    id: "red-6",
    sourcePath: "/oncoplastic",
    destinationPath: "/services/oncoplastic-breast-surgery",
    statusCode: 301,
    isActive: true,
    note: "Oncoplastic & scar-sparing surgery information route",
    hitCount: 156,
  ...
  },
  {
    id: "red-7",
    sourcePath: "/biopsy",
    destinationPath: "/services/breast-biopsy",
    statusCode: 301,
    isActive: true,
    note: "Core needle & vacuum-assisted biopsy patient guide",
    hitCount: 112,
  ...
  },
  {
    ...
    statusCode: 302,
    isActive: true,
    note: "Marengo CIMS OPD schedule & clinic timing router",
    hitCount: 88,
